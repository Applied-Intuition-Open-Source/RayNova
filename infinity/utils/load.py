...
def build_vae_raynova(args: arg_util.Args, vae_st: dict, skip_gpt: bool, device='cuda'):
    ...
    gpt_kw = dict(
        ...
        fused_mlp=args.fuse, fused_norm=args.fused_norm,
        ...
        object_cond_drop_rate=args.object_cond_drop_rate,
        bbox_img_coord=args.bbox_img_coord,
        class_names=args.class_names,
        recurrent_training=args.recurrent_training,
        use_temporal_attn=args.use_temporal_condition,
        use_condition_rope=args.condition_rope,
        map_condition=args.map_condition,
        map_condition_drop_rate=args.map_condition_drop_rate,
        map_sample_points_num=args.map_sample_points_num,
        map_names=args.map_names,
        use_frame_coordinate=args.use_frame_coordinate,
        freeze_backbone=args.freeze_backbone,
        time_chunk=args.time_chunk,
        use_local_attn=args.use_local_attn,
    ...
    model_str = model_str.replace('infinity', 'raynova')
    ...
    gpt_wo_ddp: RAYNOVA = create_model(model_str, **gpt_kw)
